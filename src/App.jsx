...
const TaxMonitoring = lazyPage(() => import('./pages/TaxMonitoring'));
const TaxSummary = lazyPage(() => import('./pages/TaxSummary'));
const TaxCalculation = lazyPage(() => import('./pages/TaxCalculation'));
const MasterData = lazyPage(() => import('./pages/MasterData'));
const Profile = lazyPage(() => import('./pages/Profile'));
const Pustaka = lazyPage(() => import('./pages/Pustaka'));
const SystemLogs = lazyPage(() => import('./pages/SystemLogs'));
const SopFlow = lazyPage(() => import('./pages/SopFlow'));
const JobDueDate = lazyPage(() => import('./pages/JobDueDate'));
const Book = lazyPage(() => import('./pages/Book'));
const EntertainmentExpenses = lazyPage(() => import('./pages/EntertainmentExpenses'));
const Invoices = lazyPage(() => import('./pages/Invoices'));
const Forwarder = lazyPage(() => import('./pages/Forwarder'));
const PdfTemplateDesigner = lazyPage(() => import('./pages/PdfTemplateDesigner'));
const AnyDoc = lazyPage(() => import('./pages/AnyDoc'));
const AiDocIntel = lazyPage(() => import('./pages/AiDocIntel'));
const AiDocTrain = lazyPage(() => import('./pages/AiDocTrain'));
const AiPdfTools = lazyPage(() => import('./pages/AiPdfTools'));
const ComponentShowcase = lazyPage(() => import('./pages/ComponentShowcase'));
const PdfViewer = lazyPage(() => import('./components/ui/PdfViewer'));
