            ...
            <div className="mb-6 flex items-start gap-3.5">
                ...
                <div>
                    ...
                    <p className={`text-xs mt-0.5 ${isDarkMode ? 'text-white/40' : 'text-slate-400'}`}>
                        Siapkan template: upload sampel, mapping kolom, uji coba, dan simpan. Setelah template siap, gunakan di menu{' '}
                        <span className="font-bold text-emerald-500">AI Document Intelligence</span>.
                    </p>
                </div>
            </div>
