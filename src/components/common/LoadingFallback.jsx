    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[400px] w-full gap-4 animate-in fade-in duration-500">
            ...
            <div className="text-center">
                <h3 className="text-lg font-black text-stone-800 dark:text-white uppercase tracking-widest">Memuat</h3>
                <p className="text-xs font-bold text-stone-400 dark:text-white/30 uppercase tracking-tighter">Menyiapkan modul aplikasi...</p>
            </div>
        </div>
    );
}
