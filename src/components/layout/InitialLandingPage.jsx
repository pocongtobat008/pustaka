...
const InitialLandingPage = ({ onClose, language = 'id' }) => {
  ...
  <motion.div
    ...
    animate={{ opacity: 1 }}
    exit={{ opacity: 0 }}
    className="fixed inset-0 z-[1000] bg-stone-50/80 dark:bg-[#0a0a0a]/90 backdrop-blur-2xl overflow-y-auto custom-scrollbar p-6 md:p-12"
  >
    <div className="max-w-6xl mx-auto">
      ...
      <motion.div
        ...
        className="bg-blue-600 rounded-[3rem] p-10 text-center text-white shadow-2xl shadow-blue-500/40 relative overflow-hidden"
      >
        <h3 className="text-3xl font-black mb-4 relative z-10">{t.ctaTitle}</h3>
        <button
          onClick={onClose}
          className="px-12 py-5 bg-white text-blue-600 rounded-[2rem] font-black uppercase tracking-widest shadow-xl transition-all hover:scale-105 active:scale-95 flex items-center gap-3 mx-auto relative z-10"
        >
