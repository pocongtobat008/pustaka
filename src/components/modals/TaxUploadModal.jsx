                    ...
                    <div className="flex-1 space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <textarea
                                    className="w-full h-24 px-4 py-2 border rounded-lg bg-white dark:bg-[#0d0d0d] dark:border-white/[0.06] dark:text-white/70 text-xs font-mono resize-none focus:ring-1 focus:ring-blue-500 outline-none transition-all"
