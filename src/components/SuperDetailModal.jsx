                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="px-4 py-3 rounded-xl gradient-bg-soft border border-slate-100 dark:border-slate-800">
                                    ...
                                    <div className="space-y-1.5 text-sm tabular-nums">
                                        ...
                                        <div className="flex justify-between"><span className="text-slate-500 text-xs">PPN {Math.round((detailTarget.ppn_rate || 0.11) * 100)}%:</span><span className="font-semibold text-slate-700 dark:text-slate-300">{formatCurrency(Math.round(Number(detailTarget.ppn) || 0))}</span></div>
