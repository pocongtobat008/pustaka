...
export default function OcrLaneStatus({ API_BASE }) {
  ...
  return (
    <div className="fixed right-4 top-4 z-50 w-80 max-w-[90vw] p-2 bg-white/90 dark:bg-[#0d0d0d]/80 rounded-xl shadow-lg border border-stone-100 dark:border-white/[0.06] backdrop-blur">
      <div className="flex items-center justify-between mb-2">
        ...
        <button onClick={() => setMinimized(s => !s)} className="p-1 rounded-md hover:bg-stone-100 dark:hover:bg-white/[0.05]">
        ...
        <div className="space-y-2">
          {lanes.map(l => (
            <div key={l.name}>
              ...
              <div className="w-full bg-stone-100 dark:bg-[#0d0d0d] rounded-full h-2 overflow-hidden">
