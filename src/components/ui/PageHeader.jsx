...
//   iconClass  : gradient ikon, default 'from-blue-500 to-blue-600'
//   title      : judul halaman
...
export const PageHeader = ({ icon: Icon, iconClass, title, subtitle, meta, actions, className = '' }) => (
    <div className={`mb-6 flex items-start gap-3.5 ${className}`}>
        <div className={`w-11 h-11 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-blue-500/20 bg-gradient-to-br ${iconClass || 'from-blue-500 to-blue-600'}`}>
